...
**Następnie:**
6. Zaznacz też 2 inne (unedited) suggestions
7. Kliknij "Zapisz zaznaczone" (total: 3 zaznaczone, 1 edited)
...
**Fix:**
5. Wypełnij back: "Test odpowiedź"
6. Validation passes, button enabled
7. Submit succeeds
...
**Attack scenario (manual API call):**
3. Spróbuj `GET /api/flashcards?user_id=B` (manipulation attempt)
...
**Attack scenario 2:**
4. User A dostaje ID fiszki User B (np. id=999)
5. Spróbuj `PUT /api/flashcards/999` (edit attempt)
